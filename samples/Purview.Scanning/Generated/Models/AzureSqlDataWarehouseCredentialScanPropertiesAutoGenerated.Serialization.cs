...
{
    public partial class AzureSqlDataWarehouseCredentialScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDataWarehouseCredentialScanPropertiesAutoGenerated DeserializeAzureSqlDataWarehouseCredentialScanPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureSqlDataWarehouseCredentialScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, serverEndpoint.Value, databaseName.Value, credential.Value);
        }
    }
}
