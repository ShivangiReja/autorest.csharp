...
{
    public partial class SqlServerDatabaseScanRulesetPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static SqlServerDatabaseScanRulesetPropertiesAutoGenerated DeserializeSqlServerDatabaseScanRulesetPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new SqlServerDatabaseScanRulesetPropertiesAutoGenerated(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
