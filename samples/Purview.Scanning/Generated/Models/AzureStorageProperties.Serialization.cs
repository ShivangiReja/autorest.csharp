...
{
    public partial class AzureStorageProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureStorageProperties DeserializeAzureStorageProperties(JsonElement element)
        {
            ...
            return new AzureStorageProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, resourceGroup.Value, subscriptionId.Value, location.Value, resourceName.Value, endpoint.Value);
        }
    }
}
