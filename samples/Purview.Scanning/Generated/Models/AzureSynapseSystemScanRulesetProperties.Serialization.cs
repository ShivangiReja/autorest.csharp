...
{
    public partial class AzureSynapseSystemScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSynapseSystemScanRulesetProperties DeserializeAzureSynapseSystemScanRulesetProperties(JsonElement element)
        {
            ...
            return new AzureSynapseSystemScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
