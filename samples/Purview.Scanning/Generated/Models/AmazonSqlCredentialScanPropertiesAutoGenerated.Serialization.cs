...
{
    public partial class AmazonSqlCredentialScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AmazonSqlCredentialScanPropertiesAutoGenerated DeserializeAmazonSqlCredentialScanPropertiesAutoGenerated(JsonElement element)
        {
            Optional<AmazonSqlCredentialScanPropertiesCredential> credential = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("credential"))
                {
                    ...
                    credential = AmazonSqlCredentialScanPropertiesCredential.DeserializeAmazonSqlCredentialScanPropertiesCredential(property.Value);
                    continue;
                }
            ...
            return new AmazonSqlCredentialScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, credential.Value, serverEndpoint.Value, databaseName.Value);
        }
    }
}
