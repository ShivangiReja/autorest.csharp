...
{
    public partial class AzureMySqlScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureMySqlScanRulesetProperties DeserializeAzureMySqlScanRulesetProperties(JsonElement element)
        {
            ...
            return new AzureMySqlScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
