...
{
    public partial class AzureResourceGroupSystemScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureResourceGroupSystemScanRulesetProperties DeserializeAzureResourceGroupSystemScanRulesetProperties(JsonElement element)
        {
            ...
            return new AzureResourceGroupSystemScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
