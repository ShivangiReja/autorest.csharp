...
{
    public partial class OracleCredentialScanPropertiesCredential : IUtf8JsonSerializable
    {
        ...
        internal static OracleCredentialScanPropertiesCredential DeserializeOracleCredentialScanPropertiesCredential(JsonElement element)
        {
            ...
            return new OracleCredentialScanPropertiesCredential(referenceName.Value, Optional.ToNullable(credentialType));
        }
    }
}
