...
{
    public partial class AzureDataExplorerScanRulesetPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureDataExplorerScanRulesetPropertiesAutoGenerated DeserializeAzureDataExplorerScanRulesetPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureDataExplorerScanRulesetPropertiesAutoGenerated(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
