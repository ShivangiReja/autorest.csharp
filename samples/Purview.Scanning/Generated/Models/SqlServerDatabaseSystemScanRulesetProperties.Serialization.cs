...
{
    public partial class SqlServerDatabaseSystemScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static SqlServerDatabaseSystemScanRulesetProperties DeserializeSqlServerDatabaseSystemScanRulesetProperties(JsonElement element)
        {
            ...
            return new SqlServerDatabaseSystemScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
