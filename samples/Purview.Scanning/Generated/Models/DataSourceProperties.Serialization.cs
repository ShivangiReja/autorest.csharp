...
{
    public partial class DataSourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static DataSourceProperties DeserializeDataSourceProperties(JsonElement element)
        {
            ...
            return new DataSourceProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value);
        }
    }
}
