...
{
    public partial class AmazonSqlCredentialScanPropertiesCredential : IUtf8JsonSerializable
    {
        ...
        internal static AmazonSqlCredentialScanPropertiesCredential DeserializeAmazonSqlCredentialScanPropertiesCredential(JsonElement element)
        {
            ...
            return new AmazonSqlCredentialScanPropertiesCredential(referenceName.Value, Optional.ToNullable(credentialType));
        }
    }
}
