...
{
    public partial class AzureFileServiceCredentialScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureFileServiceCredentialScanProperties DeserializeAzureFileServiceCredentialScanProperties(JsonElement element)
        {
            ...
            return new AzureFileServiceCredentialScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, credential.Value, shareName.Value);
        }
    }
}
