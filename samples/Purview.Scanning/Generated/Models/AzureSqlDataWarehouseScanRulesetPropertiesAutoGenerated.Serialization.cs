...
{
    public partial class AzureSqlDataWarehouseScanRulesetPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDataWarehouseScanRulesetPropertiesAutoGenerated DeserializeAzureSqlDataWarehouseScanRulesetPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureSqlDataWarehouseScanRulesetPropertiesAutoGenerated(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
