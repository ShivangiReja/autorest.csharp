...
{
    public partial class AzureDataExplorerCredentialScanPropertiesCredential : IUtf8JsonSerializable
    {
        ...
        internal static AzureDataExplorerCredentialScanPropertiesCredential DeserializeAzureDataExplorerCredentialScanPropertiesCredential(JsonElement element)
        {
            ...
            return new AzureDataExplorerCredentialScanPropertiesCredential(referenceName.Value, Optional.ToNullable(credentialType));
        }
    }
}
