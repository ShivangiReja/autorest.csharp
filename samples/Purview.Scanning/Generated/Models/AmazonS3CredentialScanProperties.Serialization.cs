...
{
    public partial class AmazonS3CredentialScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AmazonS3CredentialScanProperties DeserializeAmazonS3CredentialScanProperties(JsonElement element)
        {
            ...
            return new AmazonS3CredentialScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, credential.Value, roleARN.Value);
        }
    }
}
