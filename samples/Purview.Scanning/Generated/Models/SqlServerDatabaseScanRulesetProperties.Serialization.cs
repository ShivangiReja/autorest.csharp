...
{
    public partial class SqlServerDatabaseScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static SqlServerDatabaseScanRulesetProperties DeserializeSqlServerDatabaseScanRulesetProperties(JsonElement element)
        {
            ...
            return new SqlServerDatabaseScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
