...
{
    public partial class AmazonAccountScanRulesetPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AmazonAccountScanRulesetPropertiesAutoGenerated DeserializeAmazonAccountScanRulesetPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AmazonAccountScanRulesetPropertiesAutoGenerated(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
