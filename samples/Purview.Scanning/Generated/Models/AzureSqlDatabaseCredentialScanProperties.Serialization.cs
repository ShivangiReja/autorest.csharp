...
{
    public partial class AzureSqlDatabaseCredentialScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDatabaseCredentialScanProperties DeserializeAzureSqlDatabaseCredentialScanProperties(JsonElement element)
        {
            ...
            return new AzureSqlDatabaseCredentialScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, serverEndpoint.Value, databaseName.Value, credential.Value);
        }
    }
}
