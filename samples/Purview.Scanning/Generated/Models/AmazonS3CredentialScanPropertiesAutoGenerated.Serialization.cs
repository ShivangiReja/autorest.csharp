...
{
    public partial class AmazonS3CredentialScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AmazonS3CredentialScanPropertiesAutoGenerated DeserializeAmazonS3CredentialScanPropertiesAutoGenerated(JsonElement element)
        {
            Optional<AmazonS3CredentialScanPropertiesCredential> credential = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("credential"))
                {
                    ...
                    credential = AmazonS3CredentialScanPropertiesCredential.DeserializeAmazonS3CredentialScanPropertiesCredential(property.Value);
                    continue;
                }
            ...
            return new AmazonS3CredentialScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, credential.Value, roleARN.Value);
        }
    }
}
