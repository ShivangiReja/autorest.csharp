...
{
    public partial class SapS4HanaScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static SapS4HanaScanRulesetProperties DeserializeSapS4HanaScanRulesetProperties(JsonElement element)
        {
            ...
            return new SapS4HanaScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
