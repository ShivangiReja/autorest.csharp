...
{
    public partial class AmazonAccountCredentialScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AmazonAccountCredentialScanPropertiesAutoGenerated DeserializeAmazonAccountCredentialScanPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AmazonAccountCredentialScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, resourceTypes.Value, credential.Value);
        }
    }
}
