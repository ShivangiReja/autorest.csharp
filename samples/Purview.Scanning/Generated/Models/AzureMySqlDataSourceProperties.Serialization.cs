...
{
    public partial class AzureMySqlDataSourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureMySqlDataSourceProperties DeserializeAzureMySqlDataSourceProperties(JsonElement element)
        {
            ...
            return new AzureMySqlDataSourceProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, resourceGroup.Value, subscriptionId.Value, location.Value, resourceName.Value, serverEndpoint.Value, Optional.ToNullable(port));
        }
    }
}
