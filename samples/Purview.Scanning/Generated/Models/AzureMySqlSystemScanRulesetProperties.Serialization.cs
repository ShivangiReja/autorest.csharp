...
{
    public partial class AzureMySqlSystemScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureMySqlSystemScanRulesetProperties DeserializeAzureMySqlSystemScanRulesetProperties(JsonElement element)
        {
            ...
            return new AzureMySqlSystemScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
