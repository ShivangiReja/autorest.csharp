...
{
    public partial class PowerBISystemScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static PowerBISystemScanRulesetProperties DeserializePowerBISystemScanRulesetProperties(JsonElement element)
        {
            ...
            return new PowerBISystemScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
