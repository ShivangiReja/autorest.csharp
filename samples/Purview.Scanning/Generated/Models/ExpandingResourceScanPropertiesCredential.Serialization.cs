...
{
    public partial class ExpandingResourceScanPropertiesCredential : IUtf8JsonSerializable
    {
        ...
        internal static ExpandingResourceScanPropertiesCredential DeserializeExpandingResourceScanPropertiesCredential(JsonElement element)
        {
            ...
            return new ExpandingResourceScanPropertiesCredential(referenceName.Value, Optional.ToNullable(credentialType));
        }
    }
}
