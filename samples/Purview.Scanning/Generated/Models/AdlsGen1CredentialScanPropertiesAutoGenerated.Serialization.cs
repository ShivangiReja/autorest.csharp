...
{
    public partial class AdlsGen1CredentialScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AdlsGen1CredentialScanPropertiesAutoGenerated DeserializeAdlsGen1CredentialScanPropertiesAutoGenerated(JsonElement element)
        {
            Optional<AdlsGen1CredentialScanPropertiesCredential> credential = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("credential"))
                {
                    ...
                    credential = AdlsGen1CredentialScanPropertiesCredential.DeserializeAdlsGen1CredentialScanPropertiesCredential(property.Value);
                    continue;
                }
            ...
            return new AdlsGen1CredentialScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, credential.Value);
        }
    }
}
