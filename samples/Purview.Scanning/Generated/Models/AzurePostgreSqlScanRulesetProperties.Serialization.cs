...
{
    public partial class AzurePostgreSqlScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzurePostgreSqlScanRulesetProperties DeserializeAzurePostgreSqlScanRulesetProperties(JsonElement element)
        {
            ...
            return new AzurePostgreSqlScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
