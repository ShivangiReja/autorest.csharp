...
{
    public partial class AmazonPostgreSqlSystemScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AmazonPostgreSqlSystemScanRulesetProperties DeserializeAmazonPostgreSqlSystemScanRulesetProperties(JsonElement element)
        {
            ...
            return new AmazonPostgreSqlSystemScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
