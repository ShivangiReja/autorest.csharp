...
{
    public partial class AzureDataExplorerMsiScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureDataExplorerMsiScanProperties DeserializeAzureDataExplorerMsiScanProperties(JsonElement element)
        {
            ...
            return new AzureDataExplorerMsiScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, database.Value);
        }
    }
}
