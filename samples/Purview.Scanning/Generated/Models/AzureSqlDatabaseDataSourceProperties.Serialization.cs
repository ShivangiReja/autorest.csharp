...
{
    public partial class AzureSqlDatabaseDataSourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDatabaseDataSourceProperties DeserializeAzureSqlDatabaseDataSourceProperties(JsonElement element)
        {
            ...
            return new AzureSqlDatabaseDataSourceProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, resourceGroup.Value, subscriptionId.Value, location.Value, resourceName.Value, serverEndpoint.Value);
        }
    }
}
