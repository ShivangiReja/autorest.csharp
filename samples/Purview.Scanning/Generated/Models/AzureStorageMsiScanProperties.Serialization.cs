...
{
    public partial class AzureStorageMsiScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureStorageMsiScanProperties DeserializeAzureStorageMsiScanProperties(JsonElement element)
        {
            ...
            return new AzureStorageMsiScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value);
        }
    }
}
