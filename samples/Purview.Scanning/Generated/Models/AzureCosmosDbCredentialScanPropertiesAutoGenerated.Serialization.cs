...
{
    public partial class AzureCosmosDbCredentialScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureCosmosDbCredentialScanPropertiesAutoGenerated DeserializeAzureCosmosDbCredentialScanPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureCosmosDbCredentialScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, credential.Value, databaseName.Value);
        }
    }
}
