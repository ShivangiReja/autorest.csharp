...
{
    public partial class AdlsGen2CredentialScanPropertiesCredential : IUtf8JsonSerializable
    {
        ...
        internal static AdlsGen2CredentialScanPropertiesCredential DeserializeAdlsGen2CredentialScanPropertiesCredential(JsonElement element)
        {
            ...
            return new AdlsGen2CredentialScanPropertiesCredential(referenceName.Value, Optional.ToNullable(credentialType));
        }
    }
}
