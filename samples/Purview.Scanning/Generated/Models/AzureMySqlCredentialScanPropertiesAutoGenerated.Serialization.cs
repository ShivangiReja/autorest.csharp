...
{
    public partial class AzureMySqlCredentialScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureMySqlCredentialScanPropertiesAutoGenerated DeserializeAzureMySqlCredentialScanPropertiesAutoGenerated(JsonElement element)
        {
            Optional<string> serverEndpoint = default;
            Optional<int> port = default;
            Optional<string> databaseName = default;
            Optional<AzureMySqlScanPropertiesCredential> credential = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("credential"))
                {
                    ...
                    credential = AzureMySqlScanPropertiesCredential.DeserializeAzureMySqlScanPropertiesCredential(property.Value);
                    continue;
                }
            ...
            return new AzureMySqlCredentialScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, serverEndpoint.Value, Optional.ToNullable(port), databaseName.Value, credential.Value);
        }
    }
}
