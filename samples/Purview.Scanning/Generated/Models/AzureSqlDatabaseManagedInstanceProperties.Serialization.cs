...
{
    public partial class AzureSqlDatabaseManagedInstanceProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDatabaseManagedInstanceProperties DeserializeAzureSqlDatabaseManagedInstanceProperties(JsonElement element)
        {
            ...
            return new AzureSqlDatabaseManagedInstanceProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, resourceGroup.Value, subscriptionId.Value, location.Value, resourceName.Value, serverEndpoint.Value);
        }
    }
}
