...
{
    public partial class AzureResourceGroupProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureResourceGroupProperties DeserializeAzureResourceGroupProperties(JsonElement element)
        {
            ...
            return new AzureResourceGroupProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, subscriptionId.Value, resourceGroup.Value);
        }
    }
}
