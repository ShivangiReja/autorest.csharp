...
{
    public partial class AzureSubscriptionDataSourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSubscriptionDataSourceProperties DeserializeAzureSubscriptionDataSourceProperties(JsonElement element)
        {
            ...
            return new AzureSubscriptionDataSourceProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, subscriptionId.Value);
        }
    }
}
