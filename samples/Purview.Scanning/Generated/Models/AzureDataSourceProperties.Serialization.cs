...
{
    public partial class AzureDataSourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureDataSourceProperties DeserializeAzureDataSourceProperties(JsonElement element)
        {
            ...
            return new AzureDataSourceProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, resourceGroup.Value, subscriptionId.Value, location.Value, resourceName.Value);
        }
    }
}
