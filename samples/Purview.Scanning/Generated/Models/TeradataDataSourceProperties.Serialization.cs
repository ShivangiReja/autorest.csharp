...
{
    public partial class TeradataDataSourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static TeradataDataSourceProperties DeserializeTeradataDataSourceProperties(JsonElement element)
        {
            ...
            return new TeradataDataSourceProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, host.Value);
        }
    }
}
