...
{
    public partial class AzureDataExplorerScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureDataExplorerScanRulesetProperties DeserializeAzureDataExplorerScanRulesetProperties(JsonElement element)
        {
            ...
            return new AzureDataExplorerScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
