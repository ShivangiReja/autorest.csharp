...
{
    public partial class PowerBIMsiScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static PowerBIMsiScanPropertiesAutoGenerated DeserializePowerBIMsiScanPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new PowerBIMsiScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, Optional.ToNullable(includePersonalWorkspaces));
        }
    }
}
