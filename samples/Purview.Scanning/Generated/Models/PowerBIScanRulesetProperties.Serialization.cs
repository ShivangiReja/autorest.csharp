...
{
    public partial class PowerBIScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static PowerBIScanRulesetProperties DeserializePowerBIScanRulesetProperties(JsonElement element)
        {
            ...
            return new PowerBIScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
