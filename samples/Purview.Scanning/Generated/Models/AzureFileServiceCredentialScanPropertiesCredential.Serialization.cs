...
{
    public partial class AzureFileServiceCredentialScanPropertiesCredential : IUtf8JsonSerializable
    {
        ...
        internal static AzureFileServiceCredentialScanPropertiesCredential DeserializeAzureFileServiceCredentialScanPropertiesCredential(JsonElement element)
        {
            ...
            return new AzureFileServiceCredentialScanPropertiesCredential(referenceName.Value, Optional.ToNullable(credentialType));
        }
    }
}
