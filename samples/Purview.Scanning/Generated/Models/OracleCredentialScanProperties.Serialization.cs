...
{
    public partial class OracleCredentialScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static OracleCredentialScanProperties DeserializeOracleCredentialScanProperties(JsonElement element)
        {
            Optional<OracleCredentialScanPropertiesCredential> credential = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("credential"))
                {
                    ...
                    credential = OracleCredentialScanPropertiesCredential.DeserializeOracleCredentialScanPropertiesCredential(property.Value);
                    continue;
                }
            ...
            return new OracleCredentialScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, maximumMemoryAllowedInGb.Value, mitiCache.Value, credential.Value, schema.Value, driverLocation.Value);
        }
    }
}
