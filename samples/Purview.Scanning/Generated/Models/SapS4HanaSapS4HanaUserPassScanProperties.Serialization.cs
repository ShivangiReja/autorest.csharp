...
{
    public partial class SapS4HanaSapS4HanaUserPassScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static SapS4HanaSapS4HanaUserPassScanProperties DeserializeSapS4HanaSapS4HanaUserPassScanProperties(JsonElement element)
        {
            ...
            return new SapS4HanaSapS4HanaUserPassScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, maximumMemoryAllowedInGb.Value, mitiCache.Value, clientId.Value, username.Value, password.Value, jCoLibraryPath.Value);
        }
    }
}
