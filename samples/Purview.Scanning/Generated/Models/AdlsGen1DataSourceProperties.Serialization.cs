...
{
    public partial class AdlsGen1DataSourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static AdlsGen1DataSourceProperties DeserializeAdlsGen1DataSourceProperties(JsonElement element)
        {
            ...
            return new AdlsGen1DataSourceProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, resourceGroup.Value, subscriptionId.Value, location.Value, resourceName.Value, endpoint.Value);
        }
    }
}
