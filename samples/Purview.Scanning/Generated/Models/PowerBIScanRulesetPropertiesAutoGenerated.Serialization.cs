...
{
    public partial class PowerBIScanRulesetPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static PowerBIScanRulesetPropertiesAutoGenerated DeserializePowerBIScanRulesetPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new PowerBIScanRulesetPropertiesAutoGenerated(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
