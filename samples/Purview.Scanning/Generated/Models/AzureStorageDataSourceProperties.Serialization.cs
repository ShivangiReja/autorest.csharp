...
{
    public partial class AzureStorageDataSourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureStorageDataSourceProperties DeserializeAzureStorageDataSourceProperties(JsonElement element)
        {
            ...
            return new AzureStorageDataSourceProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, resourceGroup.Value, subscriptionId.Value, location.Value, resourceName.Value, endpoint.Value);
        }
    }
}
