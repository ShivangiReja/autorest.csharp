...
{
    public partial class AzureFileServiceProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureFileServiceProperties DeserializeAzureFileServiceProperties(JsonElement element)
        {
            ...
            return new AzureFileServiceProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, resourceGroup.Value, subscriptionId.Value, location.Value, resourceName.Value, endpoint.Value);
        }
    }
}
