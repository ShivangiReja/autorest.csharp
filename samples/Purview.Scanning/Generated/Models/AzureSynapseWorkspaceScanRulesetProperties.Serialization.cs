...
{
    public partial class AzureSynapseWorkspaceScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSynapseWorkspaceScanRulesetProperties DeserializeAzureSynapseWorkspaceScanRulesetProperties(JsonElement element)
        {
            ...
            return new AzureSynapseWorkspaceScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
