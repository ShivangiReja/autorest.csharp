...
{
    public partial class AmazonPostgreSqlDataSourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static AmazonPostgreSqlDataSourceProperties DeserializeAmazonPostgreSqlDataSourceProperties(JsonElement element)
        {
            ...
            return new AmazonPostgreSqlDataSourceProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, serverEndpoint.Value, port.Value);
        }
    }
}
