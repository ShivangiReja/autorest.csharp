...
{
    public partial class ScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static ScanRulesetProperties DeserializeScanRulesetProperties(JsonElement element)
        {
            ...
            return new ScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
