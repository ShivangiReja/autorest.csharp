...
{
    public partial class AzureSqlDatabaseManagedInstanceMsiScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDatabaseManagedInstanceMsiScanPropertiesAutoGenerated DeserializeAzureSqlDatabaseManagedInstanceMsiScanPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureSqlDatabaseManagedInstanceMsiScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, serverEndpoint.Value, databaseName.Value);
        }
    }
}
