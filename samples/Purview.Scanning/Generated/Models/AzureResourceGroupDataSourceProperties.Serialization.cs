...
{
    public partial class AzureResourceGroupDataSourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureResourceGroupDataSourceProperties DeserializeAzureResourceGroupDataSourceProperties(JsonElement element)
        {
            ...
            return new AzureResourceGroupDataSourceProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, subscriptionId.Value, resourceGroup.Value);
        }
    }
}
