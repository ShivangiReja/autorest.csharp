...
{
    public partial class AzureResourceGroupMsiScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureResourceGroupMsiScanPropertiesAutoGenerated DeserializeAzureResourceGroupMsiScanPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureResourceGroupMsiScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, resourceTypes.Value, credential.Value);
        }
    }
}
