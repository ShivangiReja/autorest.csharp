...
{
    public partial class AzurePostgreSqlSystemScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzurePostgreSqlSystemScanRulesetProperties DeserializeAzurePostgreSqlSystemScanRulesetProperties(JsonElement element)
        {
            ...
            return new AzurePostgreSqlSystemScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
