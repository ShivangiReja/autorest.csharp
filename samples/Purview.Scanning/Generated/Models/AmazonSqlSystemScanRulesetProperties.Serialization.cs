...
{
    public partial class AmazonSqlSystemScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AmazonSqlSystemScanRulesetProperties DeserializeAmazonSqlSystemScanRulesetProperties(JsonElement element)
        {
            ...
            return new AmazonSqlSystemScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
