...
{
    public partial class OracleSystemScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static OracleSystemScanRulesetProperties DeserializeOracleSystemScanRulesetProperties(JsonElement element)
        {
            ...
            return new OracleSystemScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
