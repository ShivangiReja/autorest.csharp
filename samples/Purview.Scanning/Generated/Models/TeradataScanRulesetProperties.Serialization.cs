...
{
    public partial class TeradataScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static TeradataScanRulesetProperties DeserializeTeradataScanRulesetProperties(JsonElement element)
        {
            ...
            return new TeradataScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
