...
{
    public partial class AzureSqlCredentialScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlCredentialScanProperties DeserializeAzureSqlCredentialScanProperties(JsonElement element)
        {
            ...
            return new AzureSqlCredentialScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, serverEndpoint.Value, databaseName.Value, credential.Value);
        }
    }
}
