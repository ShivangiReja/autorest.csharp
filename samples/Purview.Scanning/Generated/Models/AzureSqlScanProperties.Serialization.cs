...
{
    public partial class AzureSqlScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlScanProperties DeserializeAzureSqlScanProperties(JsonElement element)
        {
            ...
            return new AzureSqlScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, serverEndpoint.Value, databaseName.Value);
        }
    }
}
