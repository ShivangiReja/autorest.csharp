...
{
    public partial class AzureSqlDataWarehouseMsiScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDataWarehouseMsiScanPropertiesAutoGenerated DeserializeAzureSqlDataWarehouseMsiScanPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureSqlDataWarehouseMsiScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, serverEndpoint.Value, databaseName.Value);
        }
    }
}
