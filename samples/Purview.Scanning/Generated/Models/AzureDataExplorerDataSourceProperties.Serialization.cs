...
{
    public partial class AzureDataExplorerDataSourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureDataExplorerDataSourceProperties DeserializeAzureDataExplorerDataSourceProperties(JsonElement element)
        {
            ...
            return new AzureDataExplorerDataSourceProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, resourceGroup.Value, subscriptionId.Value, location.Value, resourceName.Value, endpoint.Value);
        }
    }
}
