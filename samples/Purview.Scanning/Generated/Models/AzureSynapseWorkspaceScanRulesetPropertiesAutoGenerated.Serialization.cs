...
{
    public partial class AzureSynapseWorkspaceScanRulesetPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureSynapseWorkspaceScanRulesetPropertiesAutoGenerated DeserializeAzureSynapseWorkspaceScanRulesetPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureSynapseWorkspaceScanRulesetPropertiesAutoGenerated(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
