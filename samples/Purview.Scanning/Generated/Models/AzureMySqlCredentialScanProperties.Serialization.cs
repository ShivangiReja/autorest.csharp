...
{
    public partial class AzureMySqlCredentialScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureMySqlCredentialScanProperties DeserializeAzureMySqlCredentialScanProperties(JsonElement element)
        {
            ...
            return new AzureMySqlCredentialScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, serverEndpoint.Value, Optional.ToNullable(port), databaseName.Value, credential.Value);
        }
    }
}
