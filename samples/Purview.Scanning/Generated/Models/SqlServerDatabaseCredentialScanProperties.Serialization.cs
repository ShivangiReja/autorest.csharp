...
{
    public partial class SqlServerDatabaseCredentialScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static SqlServerDatabaseCredentialScanProperties DeserializeSqlServerDatabaseCredentialScanProperties(JsonElement element)
        {
            ...
            return new SqlServerDatabaseCredentialScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, serverEndpoint.Value, databaseName.Value, credential.Value);
        }
    }
}
