...
{
    public partial class AdlsGen1CredentialScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AdlsGen1CredentialScanProperties DeserializeAdlsGen1CredentialScanProperties(JsonElement element)
        {
            ...
            return new AdlsGen1CredentialScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, credential.Value);
        }
    }
}
