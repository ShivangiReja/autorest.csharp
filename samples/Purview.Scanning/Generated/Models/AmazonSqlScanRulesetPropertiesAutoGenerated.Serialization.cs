...
{
    public partial class AmazonSqlScanRulesetPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AmazonSqlScanRulesetPropertiesAutoGenerated DeserializeAmazonSqlScanRulesetPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AmazonSqlScanRulesetPropertiesAutoGenerated(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
