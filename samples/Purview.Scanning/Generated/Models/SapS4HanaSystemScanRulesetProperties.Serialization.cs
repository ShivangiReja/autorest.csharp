...
{
    public partial class SapS4HanaSystemScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static SapS4HanaSystemScanRulesetProperties DeserializeSapS4HanaSystemScanRulesetProperties(JsonElement element)
        {
            ...
            return new SapS4HanaSystemScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
