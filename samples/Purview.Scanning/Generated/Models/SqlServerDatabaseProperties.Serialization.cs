...
{
    public partial class SqlServerDatabaseProperties : IUtf8JsonSerializable
    {
        ...
        internal static SqlServerDatabaseProperties DeserializeSqlServerDatabaseProperties(JsonElement element)
        {
            ...
            return new SqlServerDatabaseProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, resourceGroup.Value, subscriptionId.Value, location.Value, resourceName.Value, serverEndpoint.Value);
        }
    }
}
