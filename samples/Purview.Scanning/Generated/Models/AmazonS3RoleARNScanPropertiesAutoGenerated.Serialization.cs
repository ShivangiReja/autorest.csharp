...
{
    public partial class AmazonS3RoleARNScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AmazonS3RoleARNScanPropertiesAutoGenerated DeserializeAmazonS3RoleARNScanPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AmazonS3RoleARNScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, roleARN.Value);
        }
    }
}
