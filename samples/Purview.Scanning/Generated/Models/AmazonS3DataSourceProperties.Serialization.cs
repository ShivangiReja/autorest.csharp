...
{
    public partial class AmazonS3DataSourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static AmazonS3DataSourceProperties DeserializeAmazonS3DataSourceProperties(JsonElement element)
        {
            ...
            return new AmazonS3DataSourceProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, serviceUrl.Value, roleARN.Value);
        }
    }
}
