...
{
    public partial class AmazonSqlCredentialScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AmazonSqlCredentialScanProperties DeserializeAmazonSqlCredentialScanProperties(JsonElement element)
        {
            ...
            return new AmazonSqlCredentialScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, credential.Value, serverEndpoint.Value, databaseName.Value);
        }
    }
}
