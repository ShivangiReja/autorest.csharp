...
{
    public partial class SapEccScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static SapEccScanRulesetProperties DeserializeSapEccScanRulesetProperties(JsonElement element)
        {
            ...
            return new SapEccScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
