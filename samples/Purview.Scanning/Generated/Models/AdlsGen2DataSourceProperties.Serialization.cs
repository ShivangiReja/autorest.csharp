...
{
    public partial class AdlsGen2DataSourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static AdlsGen2DataSourceProperties DeserializeAdlsGen2DataSourceProperties(JsonElement element)
        {
            ...
            return new AdlsGen2DataSourceProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, resourceGroup.Value, subscriptionId.Value, location.Value, resourceName.Value, endpoint.Value);
        }
    }
}
