...
{
    public partial class AzureSqlDatabaseSystemScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDatabaseSystemScanRulesetProperties DeserializeAzureSqlDatabaseSystemScanRulesetProperties(JsonElement element)
        {
            ...
            return new AzureSqlDatabaseSystemScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
