...
{
    public partial class TeradataUserPassScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static TeradataUserPassScanPropertiesAutoGenerated DeserializeTeradataUserPassScanPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new TeradataUserPassScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, username.Value, password.Value);
        }
    }
}
