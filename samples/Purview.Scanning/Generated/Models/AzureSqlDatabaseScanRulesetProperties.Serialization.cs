...
{
    public partial class AzureSqlDatabaseScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDatabaseScanRulesetProperties DeserializeAzureSqlDatabaseScanRulesetProperties(JsonElement element)
        {
            ...
            return new AzureSqlDatabaseScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
