...
{
    public partial class AzureSqlDataWarehouseProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDataWarehouseProperties DeserializeAzureSqlDataWarehouseProperties(JsonElement element)
        {
            ...
            return new AzureSqlDataWarehouseProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, resourceGroup.Value, subscriptionId.Value, location.Value, resourceName.Value, serverEndpoint.Value);
        }
    }
}
