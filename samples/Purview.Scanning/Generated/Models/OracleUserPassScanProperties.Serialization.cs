...
{
    public partial class OracleUserPassScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static OracleUserPassScanProperties DeserializeOracleUserPassScanProperties(JsonElement element)
        {
            ...
            return new OracleUserPassScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, maximumMemoryAllowedInGb.Value, mitiCache.Value, username.Value, password.Value, schema.Value, driverLocation.Value);
        }
    }
}
