...
{
    public partial class AdlsGen2CredentialScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AdlsGen2CredentialScanProperties DeserializeAdlsGen2CredentialScanProperties(JsonElement element)
        {
            ...
            return new AdlsGen2CredentialScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, credential.Value);
        }
    }
}
