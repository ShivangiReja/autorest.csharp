...
{
    public partial class TeradataUserPassScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static TeradataUserPassScanProperties DeserializeTeradataUserPassScanProperties(JsonElement element)
        {
            ...
            return new TeradataUserPassScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, username.Value, password.Value);
        }
    }
}
