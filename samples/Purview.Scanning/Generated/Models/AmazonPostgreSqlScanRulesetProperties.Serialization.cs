...
{
    public partial class AmazonPostgreSqlScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AmazonPostgreSqlScanRulesetProperties DeserializeAmazonPostgreSqlScanRulesetProperties(JsonElement element)
        {
            ...
            return new AmazonPostgreSqlScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
