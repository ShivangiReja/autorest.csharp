...
{
    public partial class AzureDataExplorerProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureDataExplorerProperties DeserializeAzureDataExplorerProperties(JsonElement element)
        {
            ...
            return new AzureDataExplorerProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, resourceGroup.Value, subscriptionId.Value, location.Value, resourceName.Value, endpoint.Value);
        }
    }
}
