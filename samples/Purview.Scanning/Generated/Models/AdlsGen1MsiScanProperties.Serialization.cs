...
{
    public partial class AdlsGen1MsiScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AdlsGen1MsiScanProperties DeserializeAdlsGen1MsiScanProperties(JsonElement element)
        {
            ...
            return new AdlsGen1MsiScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value);
        }
    }
}
