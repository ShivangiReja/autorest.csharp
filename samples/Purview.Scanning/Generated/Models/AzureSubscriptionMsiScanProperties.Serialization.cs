...
{
    public partial class AzureSubscriptionMsiScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSubscriptionMsiScanProperties DeserializeAzureSubscriptionMsiScanProperties(JsonElement element)
        {
            ...
            return new AzureSubscriptionMsiScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, resourceTypes.Value, credential.Value);
        }
    }
}
