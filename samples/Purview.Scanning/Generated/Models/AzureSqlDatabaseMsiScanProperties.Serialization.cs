...
{
    public partial class AzureSqlDatabaseMsiScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDatabaseMsiScanProperties DeserializeAzureSqlDatabaseMsiScanProperties(JsonElement element)
        {
            ...
            return new AzureSqlDatabaseMsiScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, serverEndpoint.Value, databaseName.Value);
        }
    }
}
