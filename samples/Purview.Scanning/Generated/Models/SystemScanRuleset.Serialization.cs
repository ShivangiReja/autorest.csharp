...
{
    public partial class SystemScanRuleset : IUtf8JsonSerializable
    {
        ...
        internal static SystemScanRuleset DeserializeSystemScanRuleset(JsonElement element)
        {
            if (element.TryGetProperty("kind", out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    case "None": return PowerBISystemScanRuleset.DeserializePowerBISystemScanRuleset(element);
                }
            }
            ...
            return new SystemScanRuleset(id.Value, name.Value, Optional.ToNullable(scanRulesetType), Optional.ToNullable(status), Optional.ToNullable(version), kind);
        }
    }
}
