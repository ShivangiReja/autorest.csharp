...
{
    public partial class AmazonAccountProperties : IUtf8JsonSerializable
    {
        ...
        internal static AmazonAccountProperties DeserializeAmazonAccountProperties(JsonElement element)
        {
            ...
            return new AmazonAccountProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, awsAccountId.Value, roleARN.Value);
        }
    }
}
