...
{
    public partial class AzureResourceGroupCredentialScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureResourceGroupCredentialScanPropertiesAutoGenerated DeserializeAzureResourceGroupCredentialScanPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureResourceGroupCredentialScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, resourceTypes.Value, credential.Value);
        }
    }
}
