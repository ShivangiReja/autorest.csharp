...
{
    public partial class AzureSynapseWorkspaceCredentialScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSynapseWorkspaceCredentialScanProperties DeserializeAzureSynapseWorkspaceCredentialScanProperties(JsonElement element)
        {
            ...
            return new AzureSynapseWorkspaceCredentialScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, resourceTypes.Value, credential.Value);
        }
    }
}
