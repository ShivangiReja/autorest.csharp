...
{
    public partial class AzureStorageCredentialScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureStorageCredentialScanProperties DeserializeAzureStorageCredentialScanProperties(JsonElement element)
        {
            ...
            return new AzureStorageCredentialScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, credential.Value);
        }
    }
}
