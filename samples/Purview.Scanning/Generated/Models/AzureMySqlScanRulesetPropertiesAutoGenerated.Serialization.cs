...
{
    public partial class AzureMySqlScanRulesetPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureMySqlScanRulesetPropertiesAutoGenerated DeserializeAzureMySqlScanRulesetPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureMySqlScanRulesetPropertiesAutoGenerated(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
