...
{
    public partial class SapEccCredentialScanPropertiesCredential : IUtf8JsonSerializable
    {
        ...
        internal static SapEccCredentialScanPropertiesCredential DeserializeSapEccCredentialScanPropertiesCredential(JsonElement element)
        {
            ...
            return new SapEccCredentialScanPropertiesCredential(referenceName.Value, Optional.ToNullable(credentialType));
        }
    }
}
