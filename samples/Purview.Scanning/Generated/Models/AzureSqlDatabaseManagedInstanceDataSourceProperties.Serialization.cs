...
{
    public partial class AzureSqlDatabaseManagedInstanceDataSourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDatabaseManagedInstanceDataSourceProperties DeserializeAzureSqlDatabaseManagedInstanceDataSourceProperties(JsonElement element)
        {
            ...
            return new AzureSqlDatabaseManagedInstanceDataSourceProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, resourceGroup.Value, subscriptionId.Value, location.Value, resourceName.Value, serverEndpoint.Value);
        }
    }
}
