...
{
    public partial class TeradataSystemScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static TeradataSystemScanRulesetProperties DeserializeTeradataSystemScanRulesetProperties(JsonElement element)
        {
            ...
            return new TeradataSystemScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
