...
{
    public partial class AdlsGen1MsiScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AdlsGen1MsiScanPropertiesAutoGenerated DeserializeAdlsGen1MsiScanPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AdlsGen1MsiScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value);
        }
    }
}
