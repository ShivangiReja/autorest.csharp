...
{
    public partial class AmazonPostgreSqlCredentialScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AmazonPostgreSqlCredentialScanPropertiesAutoGenerated DeserializeAmazonPostgreSqlCredentialScanPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AmazonPostgreSqlCredentialScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, credential.Value, serverEndpoint.Value, databaseName.Value, port.Value);
        }
    }
}
