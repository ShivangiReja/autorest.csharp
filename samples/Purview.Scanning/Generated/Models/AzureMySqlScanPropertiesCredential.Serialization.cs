...
{
    public partial class AzureMySqlScanPropertiesCredential : IUtf8JsonSerializable
    {
        ...
        internal static AzureMySqlScanPropertiesCredential DeserializeAzureMySqlScanPropertiesCredential(JsonElement element)
        {
            ...
            return new AzureMySqlScanPropertiesCredential(referenceName.Value, Optional.ToNullable(credentialType));
        }
    }
}
