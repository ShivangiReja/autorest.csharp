...
{
    public partial class AmazonPostgreSqlScanRulesetPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AmazonPostgreSqlScanRulesetPropertiesAutoGenerated DeserializeAmazonPostgreSqlScanRulesetPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AmazonPostgreSqlScanRulesetPropertiesAutoGenerated(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
