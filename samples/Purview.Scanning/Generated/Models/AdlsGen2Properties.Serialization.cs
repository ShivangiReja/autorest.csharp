...
{
    public partial class AdlsGen2Properties : IUtf8JsonSerializable
    {
        ...
        internal static AdlsGen2Properties DeserializeAdlsGen2Properties(JsonElement element)
        {
            ...
            return new AdlsGen2Properties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, resourceGroup.Value, subscriptionId.Value, location.Value, resourceName.Value, endpoint.Value);
        }
    }
}
