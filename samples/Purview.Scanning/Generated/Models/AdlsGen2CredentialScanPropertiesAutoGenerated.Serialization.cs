...
{
    public partial class AdlsGen2CredentialScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AdlsGen2CredentialScanPropertiesAutoGenerated DeserializeAdlsGen2CredentialScanPropertiesAutoGenerated(JsonElement element)
        {
            Optional<AdlsGen2CredentialScanPropertiesCredential> credential = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("credential"))
                {
                    ...
                    credential = AdlsGen2CredentialScanPropertiesCredential.DeserializeAdlsGen2CredentialScanPropertiesCredential(property.Value);
                    continue;
                }
            ...
            return new AdlsGen2CredentialScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, credential.Value);
        }
    }
}
