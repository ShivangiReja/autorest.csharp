...
{
    public partial class AzureSqlCredentialScanPropertiesCredential : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlCredentialScanPropertiesCredential DeserializeAzureSqlCredentialScanPropertiesCredential(JsonElement element)
        {
            ...
            return new AzureSqlCredentialScanPropertiesCredential(referenceName.Value, Optional.ToNullable(credentialType));
        }
    }
}
