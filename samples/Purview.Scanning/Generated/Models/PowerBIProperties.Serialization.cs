...
{
    public partial class PowerBIProperties : IUtf8JsonSerializable
    {
        ...
        internal static PowerBIProperties DeserializePowerBIProperties(JsonElement element)
        {
            ...
            return new PowerBIProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, tenant.Value);
        }
    }
}
