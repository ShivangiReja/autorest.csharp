...
{
    public partial class AzureCosmosDbCredentialScanPropertiesCredential : IUtf8JsonSerializable
    {
        ...
        internal static AzureCosmosDbCredentialScanPropertiesCredential DeserializeAzureCosmosDbCredentialScanPropertiesCredential(JsonElement element)
        {
            ...
            return new AzureCosmosDbCredentialScanPropertiesCredential(referenceName.Value, Optional.ToNullable(credentialType));
        }
    }
}
