...
{
    public partial class AzureCosmosDbProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureCosmosDbProperties DeserializeAzureCosmosDbProperties(JsonElement element)
        {
            ...
            return new AzureCosmosDbProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, resourceGroup.Value, subscriptionId.Value, location.Value, resourceName.Value, accountUri.Value);
        }
    }
}
