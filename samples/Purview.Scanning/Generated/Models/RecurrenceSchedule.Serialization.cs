...
namespace Purview.Scanning.Models
{
    public partial class RecurrenceSchedule : IUtf8JsonSerializable
    {
        ...
        internal static RecurrenceSchedule DeserializeRecurrenceSchedule(JsonElement element)
        {
            ...
            return new RecurrenceSchedule(Optional.ToDictionary(additionalProperties), Optional.ToList(minutes), Optional.ToList(hours), Optional.ToList(weekDays), Optional.ToList(monthDays), Optional.ToList(monthlyOccurrences));
        }
    }
}
