...
{
    public partial class AzureSynapseWorkspaceMsiScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSynapseWorkspaceMsiScanProperties DeserializeAzureSynapseWorkspaceMsiScanProperties(JsonElement element)
        {
            ...
            return new AzureSynapseWorkspaceMsiScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, resourceTypes.Value, credential.Value);
        }
    }
}
