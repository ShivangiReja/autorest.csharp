...
{
    public partial class AzureSqlDatabaseManagedInstanceCredentialScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDatabaseManagedInstanceCredentialScanProperties DeserializeAzureSqlDatabaseManagedInstanceCredentialScanProperties(JsonElement element)
        {
            ...
            return new AzureSqlDatabaseManagedInstanceCredentialScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, serverEndpoint.Value, databaseName.Value, credential.Value);
        }
    }
}
