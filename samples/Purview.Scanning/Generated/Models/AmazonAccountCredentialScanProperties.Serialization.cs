...
{
    public partial class AmazonAccountCredentialScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AmazonAccountCredentialScanProperties DeserializeAmazonAccountCredentialScanProperties(JsonElement element)
        {
            ...
            return new AmazonAccountCredentialScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, resourceTypes.Value, credential.Value);
        }
    }
}
