...
{
    public partial class AzureSqlDatabaseProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDatabaseProperties DeserializeAzureSqlDatabaseProperties(JsonElement element)
        {
            ...
            return new AzureSqlDatabaseProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, resourceGroup.Value, subscriptionId.Value, location.Value, resourceName.Value, serverEndpoint.Value);
        }
    }
}
