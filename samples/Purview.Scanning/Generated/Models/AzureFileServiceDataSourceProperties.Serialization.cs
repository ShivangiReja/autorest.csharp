...
{
    public partial class AzureFileServiceDataSourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureFileServiceDataSourceProperties DeserializeAzureFileServiceDataSourceProperties(JsonElement element)
        {
            ...
            return new AzureFileServiceDataSourceProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, resourceGroup.Value, subscriptionId.Value, location.Value, resourceName.Value, endpoint.Value);
        }
    }
}
