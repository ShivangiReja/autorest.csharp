...
{
    public partial class SapS4HanaSapS4HanaCredentialScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static SapS4HanaSapS4HanaCredentialScanPropertiesAutoGenerated DeserializeSapS4HanaSapS4HanaCredentialScanPropertiesAutoGenerated(JsonElement element)
        {
            Optional<string> clientId = default;
            Optional<SapS4HanaSapS4HanaCredentialScanPropertiesCredential> credential = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("credential"))
                {
                    ...
                    credential = SapS4HanaSapS4HanaCredentialScanPropertiesCredential.DeserializeSapS4HanaSapS4HanaCredentialScanPropertiesCredential(property.Value);
                    continue;
                }
