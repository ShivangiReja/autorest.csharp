...
{
    public partial class AzureDataExplorerCredentialScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureDataExplorerCredentialScanPropertiesAutoGenerated DeserializeAzureDataExplorerCredentialScanPropertiesAutoGenerated(JsonElement element)
        {
            Optional<AzureDataExplorerCredentialScanPropertiesCredential> credential = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("credential"))
                {
                    ...
                    credential = AzureDataExplorerCredentialScanPropertiesCredential.DeserializeAzureDataExplorerCredentialScanPropertiesCredential(property.Value);
                    continue;
                }
            ...
            return new AzureDataExplorerCredentialScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, credential.Value, database.Value);
        }
    }
}
