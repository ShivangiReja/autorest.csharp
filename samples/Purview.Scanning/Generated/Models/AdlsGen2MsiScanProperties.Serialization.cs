...
{
    public partial class AdlsGen2MsiScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AdlsGen2MsiScanProperties DeserializeAdlsGen2MsiScanProperties(JsonElement element)
        {
            ...
            return new AdlsGen2MsiScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value);
        }
    }
}
