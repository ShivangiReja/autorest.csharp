...
{
    public partial class TeradataProperties : IUtf8JsonSerializable
    {
        ...
        internal static TeradataProperties DeserializeTeradataProperties(JsonElement element)
        {
            ...
            return new TeradataProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, host.Value);
        }
    }
}
