...
{
    public partial class AmazonPostgreSqlProperties : IUtf8JsonSerializable
    {
        ...
        internal static AmazonPostgreSqlProperties DeserializeAmazonPostgreSqlProperties(JsonElement element)
        {
            ...
            return new AmazonPostgreSqlProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, serverEndpoint.Value, port.Value);
        }
    }
}
