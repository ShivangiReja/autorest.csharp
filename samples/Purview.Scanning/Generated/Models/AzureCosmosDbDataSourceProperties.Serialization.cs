...
{
    public partial class AzureCosmosDbDataSourceProperties : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(AccountUri))
            {
                ...
                writer.WriteStringValue(AccountUri);
            }
        ...
        internal static AzureCosmosDbDataSourceProperties DeserializeAzureCosmosDbDataSourceProperties(JsonElement element)
        {
            Optional<string> accountUri = default;
            ...
            {
                if (property.NameEquals("accountUri"))
                {
                    accountUri = property.Value.GetString();
                    continue;
                }
            ...
            return new AzureCosmosDbDataSourceProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, resourceGroup.Value, subscriptionId.Value, location.Value, resourceName.Value, accountUri.Value);
        }
    }
}
