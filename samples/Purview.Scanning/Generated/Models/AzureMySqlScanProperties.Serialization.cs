...
{
    public partial class AzureMySqlScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureMySqlScanProperties DeserializeAzureMySqlScanProperties(JsonElement element)
        {
            ...
            return new AzureMySqlScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, serverEndpoint.Value, Optional.ToNullable(port), databaseName.Value, credential.Value);
        }
    }
}
