...
{
    public partial class AzureResourceGroupScanRulesetPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureResourceGroupScanRulesetPropertiesAutoGenerated DeserializeAzureResourceGroupScanRulesetPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureResourceGroupScanRulesetPropertiesAutoGenerated(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
