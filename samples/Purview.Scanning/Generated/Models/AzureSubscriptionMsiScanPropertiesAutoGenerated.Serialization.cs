...
{
    public partial class AzureSubscriptionMsiScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureSubscriptionMsiScanPropertiesAutoGenerated DeserializeAzureSubscriptionMsiScanPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureSubscriptionMsiScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, resourceTypes.Value, credential.Value);
        }
    }
}
