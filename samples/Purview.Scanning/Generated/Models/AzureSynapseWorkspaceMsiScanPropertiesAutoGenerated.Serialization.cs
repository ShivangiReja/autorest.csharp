...
{
    public partial class AzureSynapseWorkspaceMsiScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureSynapseWorkspaceMsiScanPropertiesAutoGenerated DeserializeAzureSynapseWorkspaceMsiScanPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureSynapseWorkspaceMsiScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, resourceTypes.Value, credential.Value);
        }
    }
}
