...
{
    public partial class AdlsGen2MsiScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AdlsGen2MsiScanPropertiesAutoGenerated DeserializeAdlsGen2MsiScanPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AdlsGen2MsiScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value);
        }
    }
}
