...
{
    public partial class AzureDataExplorerCredentialScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureDataExplorerCredentialScanProperties DeserializeAzureDataExplorerCredentialScanProperties(JsonElement element)
        {
            ...
            return new AzureDataExplorerCredentialScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, credential.Value, database.Value);
        }
    }
}
