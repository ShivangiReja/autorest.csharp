...
{
    public partial class OracleScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static OracleScanRulesetProperties DeserializeOracleScanRulesetProperties(JsonElement element)
        {
            ...
            return new OracleScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
