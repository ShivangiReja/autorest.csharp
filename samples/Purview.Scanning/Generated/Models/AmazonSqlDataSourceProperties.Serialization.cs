...
{
    public partial class AmazonSqlDataSourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static AmazonSqlDataSourceProperties DeserializeAmazonSqlDataSourceProperties(JsonElement element)
        {
            ...
            return new AmazonSqlDataSourceProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, serverEndpoint.Value);
        }
    }
}
