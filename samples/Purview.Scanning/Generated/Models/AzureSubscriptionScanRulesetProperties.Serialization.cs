...
{
    public partial class AzureSubscriptionScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSubscriptionScanRulesetProperties DeserializeAzureSubscriptionScanRulesetProperties(JsonElement element)
        {
            ...
            return new AzureSubscriptionScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
