...
{
    public partial class AmazonAccountScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AmazonAccountScanRulesetProperties DeserializeAmazonAccountScanRulesetProperties(JsonElement element)
        {
            ...
            return new AmazonAccountScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
