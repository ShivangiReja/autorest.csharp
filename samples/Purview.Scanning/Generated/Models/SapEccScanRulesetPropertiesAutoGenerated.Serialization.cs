...
{
    public partial class SapEccScanRulesetPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static SapEccScanRulesetPropertiesAutoGenerated DeserializeSapEccScanRulesetPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new SapEccScanRulesetPropertiesAutoGenerated(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
