...
{
    public partial class SqlServerDatabaseDataSourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static SqlServerDatabaseDataSourceProperties DeserializeSqlServerDatabaseDataSourceProperties(JsonElement element)
        {
            ...
            return new SqlServerDatabaseDataSourceProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, resourceGroup.Value, subscriptionId.Value, location.Value, resourceName.Value, serverEndpoint.Value);
        }
    }
}
