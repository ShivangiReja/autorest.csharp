...
{
    public partial class AzureSynapseWorkspaceSystemScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSynapseWorkspaceSystemScanRulesetProperties DeserializeAzureSynapseWorkspaceSystemScanRulesetProperties(JsonElement element)
        {
            ...
            return new AzureSynapseWorkspaceSystemScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
