...
{
    public partial class AzureSqlDataWarehouseCredentialScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDataWarehouseCredentialScanProperties DeserializeAzureSqlDataWarehouseCredentialScanProperties(JsonElement element)
        {
            ...
            return new AzureSqlDataWarehouseCredentialScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, serverEndpoint.Value, databaseName.Value, credential.Value);
        }
    }
}
