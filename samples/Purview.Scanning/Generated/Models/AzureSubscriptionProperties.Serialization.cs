...
{
    public partial class AzureSubscriptionProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSubscriptionProperties DeserializeAzureSubscriptionProperties(JsonElement element)
        {
            ...
            return new AzureSubscriptionProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, subscriptionId.Value);
        }
    }
}
