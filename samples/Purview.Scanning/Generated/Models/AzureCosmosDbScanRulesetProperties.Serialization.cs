...
{
    public partial class AzureCosmosDbScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureCosmosDbScanRulesetProperties DeserializeAzureCosmosDbScanRulesetProperties(JsonElement element)
        {
            ...
            return new AzureCosmosDbScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
