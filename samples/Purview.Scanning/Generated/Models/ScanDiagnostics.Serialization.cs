...
namespace Purview.Scanning.Models
{
    ...
    {
        internal static ScanDiagnostics DeserializeScanDiagnostics(JsonElement element)
        {
            ...
            return new ScanDiagnostics(Optional.ToList(notifications), Optional.ToDictionary(exceptionCountMap));
        }
    }
}
