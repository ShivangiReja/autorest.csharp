...
{
    public partial class AzureStorageCredentialScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureStorageCredentialScanPropertiesAutoGenerated DeserializeAzureStorageCredentialScanPropertiesAutoGenerated(JsonElement element)
        {
            Optional<AzureStorageCredentialScanPropertiesCredential> credential = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("credential"))
                {
                    ...
                    credential = AzureStorageCredentialScanPropertiesCredential.DeserializeAzureStorageCredentialScanPropertiesCredential(property.Value);
                    continue;
                }
            ...
            return new AzureStorageCredentialScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, credential.Value);
        }
    }
}
