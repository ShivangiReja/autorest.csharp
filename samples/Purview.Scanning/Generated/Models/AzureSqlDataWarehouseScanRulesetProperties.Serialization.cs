...
{
    public partial class AzureSqlDataWarehouseScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDataWarehouseScanRulesetProperties DeserializeAzureSqlDataWarehouseScanRulesetProperties(JsonElement element)
        {
            ...
            return new AzureSqlDataWarehouseScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
