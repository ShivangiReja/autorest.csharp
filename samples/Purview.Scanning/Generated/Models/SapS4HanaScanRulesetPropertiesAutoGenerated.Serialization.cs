...
{
    public partial class SapS4HanaScanRulesetPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static SapS4HanaScanRulesetPropertiesAutoGenerated DeserializeSapS4HanaScanRulesetPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new SapS4HanaScanRulesetPropertiesAutoGenerated(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
