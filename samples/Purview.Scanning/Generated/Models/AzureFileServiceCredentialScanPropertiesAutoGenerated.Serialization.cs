...
{
    public partial class AzureFileServiceCredentialScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureFileServiceCredentialScanPropertiesAutoGenerated DeserializeAzureFileServiceCredentialScanPropertiesAutoGenerated(JsonElement element)
        {
            Optional<AzureFileServiceCredentialScanPropertiesCredential> credential = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("credential"))
                {
                    ...
                    credential = AzureFileServiceCredentialScanPropertiesCredential.DeserializeAzureFileServiceCredentialScanPropertiesCredential(property.Value);
                    continue;
                }
            ...
            return new AzureFileServiceCredentialScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, credential.Value, shareName.Value);
        }
    }
}
