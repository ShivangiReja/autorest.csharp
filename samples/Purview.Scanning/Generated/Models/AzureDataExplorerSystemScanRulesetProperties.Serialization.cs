...
{
    public partial class AzureDataExplorerSystemScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureDataExplorerSystemScanRulesetProperties DeserializeAzureDataExplorerSystemScanRulesetProperties(JsonElement element)
        {
            ...
            return new AzureDataExplorerSystemScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
