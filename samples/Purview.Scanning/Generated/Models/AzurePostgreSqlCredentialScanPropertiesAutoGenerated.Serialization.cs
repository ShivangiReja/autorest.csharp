...
{
    public partial class AzurePostgreSqlCredentialScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            {
                writer.WritePropertyName("sslMode");
                writer.WriteNumberValue(SslMode.Value);
            }
        ...
        internal static AzurePostgreSqlCredentialScanPropertiesAutoGenerated DeserializeAzurePostgreSqlCredentialScanPropertiesAutoGenerated(JsonElement element)
        {
            Optional<AzurePostgreSqlCredentialScanPropertiesCredential> credential = default;
            Optional<string> serverEndpoint = default;
            Optional<string> databaseName = default;
            Optional<int> port = default;
            Optional<int> sslMode = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("credential"))
                {
                    ...
                    credential = AzurePostgreSqlCredentialScanPropertiesCredential.DeserializeAzurePostgreSqlCredentialScanPropertiesCredential(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("sslMode"))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        property.ThrowNonNullablePropertyIsNull();
                    ...
                    sslMode = property.Value.GetInt32();
                    continue;
                }
            ...
            return new AzurePostgreSqlCredentialScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, credential.Value, serverEndpoint.Value, databaseName.Value, Optional.ToNullable(port), Optional.ToNullable(sslMode));
        }
    }
}
