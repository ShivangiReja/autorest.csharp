...
{
    public partial class AzureSynapseCredentialScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSynapseCredentialScanProperties DeserializeAzureSynapseCredentialScanProperties(JsonElement element)
        {
            ...
            return new AzureSynapseCredentialScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, resourceTypes.Value, credential.Value);
        }
    }
}
