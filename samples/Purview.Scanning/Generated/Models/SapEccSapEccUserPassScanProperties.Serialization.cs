...
{
    public partial class SapEccSapEccUserPassScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static SapEccSapEccUserPassScanProperties DeserializeSapEccSapEccUserPassScanProperties(JsonElement element)
        {
            ...
            return new SapEccSapEccUserPassScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, maximumMemoryAllowedInGb.Value, mitiCache.Value, clientId.Value, username.Value, password.Value, jCoLibraryPath.Value);
        }
    }
}
