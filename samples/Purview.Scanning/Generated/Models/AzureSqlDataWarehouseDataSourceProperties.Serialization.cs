...
{
    public partial class AzureSqlDataWarehouseDataSourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDataWarehouseDataSourceProperties DeserializeAzureSqlDataWarehouseDataSourceProperties(JsonElement element)
        {
            ...
            return new AzureSqlDataWarehouseDataSourceProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, resourceGroup.Value, subscriptionId.Value, location.Value, resourceName.Value, serverEndpoint.Value);
        }
    }
}
