...
{
    public partial class AzureSynapseScanRulesetPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureSynapseScanRulesetPropertiesAutoGenerated DeserializeAzureSynapseScanRulesetPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureSynapseScanRulesetPropertiesAutoGenerated(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
