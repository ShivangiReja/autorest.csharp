...
{
    public partial class AzureSqlDatabaseManagedInstanceScanRulesetPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDatabaseManagedInstanceScanRulesetPropertiesAutoGenerated DeserializeAzureSqlDatabaseManagedInstanceScanRulesetPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureSqlDatabaseManagedInstanceScanRulesetPropertiesAutoGenerated(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
