...
{
    public partial class ExpandingResourceScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static ExpandingResourceScanProperties DeserializeExpandingResourceScanProperties(JsonElement element)
        {
            ...
            return new ExpandingResourceScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, resourceTypes.Value, credential.Value);
        }
    }
}
