...
{
    public partial class AzurePostgreSqlScanRulesetPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzurePostgreSqlScanRulesetPropertiesAutoGenerated DeserializeAzurePostgreSqlScanRulesetPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzurePostgreSqlScanRulesetPropertiesAutoGenerated(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
