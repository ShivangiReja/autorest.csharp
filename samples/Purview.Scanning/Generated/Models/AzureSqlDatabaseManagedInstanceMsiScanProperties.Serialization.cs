...
{
    public partial class AzureSqlDatabaseManagedInstanceMsiScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDatabaseManagedInstanceMsiScanProperties DeserializeAzureSqlDatabaseManagedInstanceMsiScanProperties(JsonElement element)
        {
            ...
            return new AzureSqlDatabaseManagedInstanceMsiScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, serverEndpoint.Value, databaseName.Value);
        }
    }
}
