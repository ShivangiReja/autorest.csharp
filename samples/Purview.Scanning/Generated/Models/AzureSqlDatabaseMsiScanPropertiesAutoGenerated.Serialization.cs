...
{
    public partial class AzureSqlDatabaseMsiScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDatabaseMsiScanPropertiesAutoGenerated DeserializeAzureSqlDatabaseMsiScanPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureSqlDatabaseMsiScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, serverEndpoint.Value, databaseName.Value);
        }
    }
}
