...
{
    public partial class AzureSynapseMsiScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureSynapseMsiScanPropertiesAutoGenerated DeserializeAzureSynapseMsiScanPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureSynapseMsiScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, resourceTypes.Value, credential.Value);
        }
    }
}
