...
{
    public partial class SystemClassificationRulePropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static SystemClassificationRulePropertiesAutoGenerated DeserializeSystemClassificationRulePropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new SystemClassificationRulePropertiesAutoGenerated(description.Value, Optional.ToNullable(version), classificationName.Value, Optional.ToNullable(ruleStatus), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt));
        }
    }
}
