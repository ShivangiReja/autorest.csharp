...
{
    public partial class AzureMySqlProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureMySqlProperties DeserializeAzureMySqlProperties(JsonElement element)
        {
            ...
            return new AzureMySqlProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, resourceGroup.Value, subscriptionId.Value, location.Value, resourceName.Value, serverEndpoint.Value, Optional.ToNullable(port));
        }
    }
}
