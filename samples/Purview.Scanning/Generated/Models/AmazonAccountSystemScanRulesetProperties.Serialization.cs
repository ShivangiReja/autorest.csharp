...
{
    public partial class AmazonAccountSystemScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AmazonAccountSystemScanRulesetProperties DeserializeAmazonAccountSystemScanRulesetProperties(JsonElement element)
        {
            ...
            return new AmazonAccountSystemScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
