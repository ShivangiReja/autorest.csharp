...
{
    public partial class AmazonPostgreSqlCredentialScanPropertiesCredential : IUtf8JsonSerializable
    {
        ...
        internal static AmazonPostgreSqlCredentialScanPropertiesCredential DeserializeAmazonPostgreSqlCredentialScanPropertiesCredential(JsonElement element)
        {
            ...
            return new AmazonPostgreSqlCredentialScanPropertiesCredential(referenceName.Value, Optional.ToNullable(credentialType));
        }
    }
}
