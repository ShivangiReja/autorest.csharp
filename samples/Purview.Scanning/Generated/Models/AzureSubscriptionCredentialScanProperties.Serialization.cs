...
{
    public partial class AzureSubscriptionCredentialScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSubscriptionCredentialScanProperties DeserializeAzureSubscriptionCredentialScanProperties(JsonElement element)
        {
            ...
            return new AzureSubscriptionCredentialScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, resourceTypes.Value, credential.Value);
        }
    }
}
