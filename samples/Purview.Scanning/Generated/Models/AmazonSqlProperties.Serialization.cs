...
{
    public partial class AmazonSqlProperties : IUtf8JsonSerializable
    {
        ...
        internal static AmazonSqlProperties DeserializeAmazonSqlProperties(JsonElement element)
        {
            ...
            return new AmazonSqlProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, serverEndpoint.Value);
        }
    }
}
