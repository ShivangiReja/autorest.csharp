...
{
    public partial class SapEccSystemScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static SapEccSystemScanRulesetProperties DeserializeSapEccSystemScanRulesetProperties(JsonElement element)
        {
            ...
            return new SapEccSystemScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
