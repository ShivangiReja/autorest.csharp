...
{
    public partial class TeradataCredentialScanPropertiesCredential : IUtf8JsonSerializable
    {
        ...
        internal static TeradataCredentialScanPropertiesCredential DeserializeTeradataCredentialScanPropertiesCredential(JsonElement element)
        {
            ...
            return new TeradataCredentialScanPropertiesCredential(referenceName.Value, Optional.ToNullable(credentialType));
        }
    }
}
