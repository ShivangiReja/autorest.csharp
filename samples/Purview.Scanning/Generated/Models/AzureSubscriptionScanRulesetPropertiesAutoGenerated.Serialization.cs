...
{
    public partial class AzureSubscriptionScanRulesetPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureSubscriptionScanRulesetPropertiesAutoGenerated DeserializeAzureSubscriptionScanRulesetPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureSubscriptionScanRulesetPropertiesAutoGenerated(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
