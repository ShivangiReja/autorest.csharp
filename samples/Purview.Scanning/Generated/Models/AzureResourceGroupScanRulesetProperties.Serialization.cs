...
{
    public partial class AzureResourceGroupScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureResourceGroupScanRulesetProperties DeserializeAzureResourceGroupScanRulesetProperties(JsonElement element)
        {
            ...
            return new AzureResourceGroupScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
