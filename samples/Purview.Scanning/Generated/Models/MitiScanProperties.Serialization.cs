...
{
    public partial class MitiScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static MitiScanProperties DeserializeMitiScanProperties(JsonElement element)
        {
            ...
            return new MitiScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, maximumMemoryAllowedInGb.Value, mitiCache.Value);
        }
    }
}
